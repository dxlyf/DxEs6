...
function getDiv() {
  var _name$age$address = {
    name: '李三',
    age: 19,
    address: 'ffd'
  },
      name = _name$age$address.name,
      list = _objectWithoutProperties(_name$age$address, ['name']);
...
var HeadView = exports.HeadView = function (_View) {
    _inherits(HeadView, _View);

    function HeadView() {
        _classCallCheck(this, HeadView);

        return _possibleConstructorReturn(this, (HeadView.__proto__ || Object.getPrototypeOf(HeadView)).apply(this, arguments));
    }

    _createClass(HeadView, [{
        key: "getMessage",
        value: function getMessage() {
            var name = _get(HeadView.prototype.__proto__ || Object.getPrototypeOf(HeadView.prototype), "_name", this);
        }
    }]);
